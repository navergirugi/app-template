export const Config = {
  ...
  // 웹뷰 설정
  MAIN_URL: "http://localhost:3000", // 메인으로 띄울 웹사이트
  ALLOWED_DOMAINS: ["localhost", "naver.com", "nid.naver.com"], // 허용할 도메인 (부분 일치 체크)
  ...
  DEFAULT_ONBOARDING_DATA: [
    {
      ...
      image:
        "https://images.unsplash.com/photo-1596464716127-f9a87ae52620?q=80&w=1000&auto=format&fit=crop",
    },
    {
      id: 2,
      title: "편리한 기능",
